...
export const posts: BlogPost[] = [
  {
    ...
    title:
      "Warum Neuwagen im Rohzustand sind und sofort geschützt werden sollten",
    metaTitle:
      "Warum Neuwagen im Rohzustand sind und sofort geschützt werden sollten",
    metaDescription:
      "Ein Neuwagen steht beim Kunden oft für Perfektion. Viele gehen davon aus, dass ein Fahrzeug, das frisch vom Band kommt, in einem makellosen Zustand übergeben wird – die Realität sieht anders aus.",
    publishedAt: "25. November 2025",
    publishedIso: "2025-11-25",
    intro:
  ...
  },
  {
    ...
    title: "Warum Luxemburger Kunden bis ins Saarland fahren",
    metaTitle: "Warum Luxemburger Kunden bis ins Saarland fahren",
    metaDescription:
    ...
    publishedIso: "2025-11-25",
    intro:
      "Luxemburg ist bekannt für hochwertige Fahrzeuge und anspruchsvolle Autobesitzer. Doch was viele überrascht: Immer mehr Kunden aus Luxemburg kommen bewusst ins Saarland, um ihre Keramikversiegelung professionell durchführen zu lassen. Und sie tun das nicht wegen des Preises, sondern wegen der Qualität.",
    paragraphs: [
  ...
  },
  {
    ...
    title: "Keramikversiegelung – warum billig am Ende teuer ist",
    metaTitle: "Keramikversiegelung – warum billig am Ende teuer ist",
    metaDescription:
      "Keramikversiegelungen werden mittlerweile überall angeboten. Werkstätten, Autohäuser, Waschstraßen und mobile Aufbereiter werben mit großen Versprechen und kleinen Preisen. Die häufigsten Fehler und wie du sie erkennst.",
    publishedAt: "25. November 2025",
    publishedIso: "2025-11-25",
    intro:
  ...
  },
  {
    ...
    title: "Schwarzes Fahrzeug richtig polieren & versiegeln",
    metaTitle: "Schwarzes Fahrzeug richtig polieren & versiegeln",
    metaDescription:
      "Schwarzer Lack ist die Königsklasse. Er zeigt jede Spur, jede Unsauberkeit und jeden noch so kleinen Polierfehler. Warum Präzision bei schwarzen Fahrzeugen entscheidend ist.",
    publishedAt: "25. November 2025",
    publishedIso: "2025-11-25",
    intro:
      "Schwarzer Lack ist die Königsklasse. Er zeigt jede Spur, jede Unsauberkeit und jeden noch so kleinen Polierfehler. Viele Besitzer hochwertiger Fahrzeuge wissen das, dennoch sind sie überrascht, wie empfindlich ein schwarzer Neuwagen tatsächlich ist.",
    paragraphs: [
      "Die Probleme beginnen schon beim Händler. Transportspuren, Hologramme, Waschkratzer und matte Stellen sind bei schwarzem Lack ab Werk fast normal.",
