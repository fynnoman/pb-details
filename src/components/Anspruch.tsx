          ...
          <div className="col-span-12 lg:col-span-6 order-2 lg:order-1">
            <div className="relative aspect-[4/5] sm:aspect-[4/5] rounded-2xl sm:rounded-[2rem] overflow-hidden">
              ...
              <motion.div
                ...
                className="absolute right-3 bottom-3 sm:right-8 sm:bottom-8 glass-strong rounded-xl sm:rounded-2xl px-3 py-2.5 sm:px-5 sm:py-4 max-w-[170px] sm:max-w-[240px] shadow-xl"
              >
                <div className="text-[9px] sm:text-[10px] tracking-[0.28em] sm:tracking-[0.32em] uppercase text-[var(--ink-mute)] mb-1">
