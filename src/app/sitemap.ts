...
const pages: Entry[] = [
  ...
  { path: "/leistungen/keramikversiegelung/", lastModified: "2026-07-21", changeFrequency: "monthly", priority: 0.9 },
  { path: "/unfallschaden/", lastModified: "2026-07-21", changeFrequency: "monthly", priority: 0.9 },
  ...
  { path: "/referenzen/", lastModified: "2026-06-18", changeFrequency: "monthly", priority: 0.7 },
  { path: "/ueber-uns/", lastModified: "2026-06-15", changeFrequency: "monthly", priority: 0.6 },
